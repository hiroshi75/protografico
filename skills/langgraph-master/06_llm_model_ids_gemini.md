...
以下多数のモデルがありますが、一般的に開発時に推奨されるのは現時点で`gemini-2.5-flash` です。コストと性能のバランスが良く、幅広い用途に対応します。
...
| `gemini-2.5-flash-lite` | 1M           | -        | 軽量高速               |

**注**: 無料版は約 32K トークンに制限。Gemini Advanced (2.5 Pro) は 1M トークン。
...
| 用途               | 推奨モデル                     |
| ------------------ | ------------------------------ |
| コスト重視         | `gemini-2.5-flash-lite`        |
| バランス           | `gemini-2.5-flash`             |
| 性能重視           | `google/gemini-3-pro`          |
