...
- [Tool_Definition.md](Tool_Definition.md) - Tool definition
- [Command_API.md](Command_API.md) - Integration with Command API
- [05_応用機能/HumanInTheLoop.md](../05_応用機能/HumanInTheLoop.md) - Combining with approval flows
